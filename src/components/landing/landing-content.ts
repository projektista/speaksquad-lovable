      ...
      },
      {
        ...
        items: [
          ...
          { q: "レッスンに必要なものは?", a: "ゲーム(MinecraftまたはFortnite)をPCかコンソールにインストール済みであること、先生とのビデオ通話用のZoom、カメラ付きの端末(PC・タブレット・スマホ)、マイク付きイヤホン(推奨、必須ではありません)。" },
          {
            ...
            a: [
              "安定した通信環境と動作する端末を用意するのは生徒側の責任です。そのため原則として、生徒側の technical な問題はクレジット消費となり、先生が50分まるごと待った場合も同じです。例外は、予約時刻から10分以内に通信や端末の不具合を連絡いただいた場合で、そのときはクレジットを返却します。入室後にそれ以降で切断し戻れなかった場合も、レッスン時刻から2時間以内であれば申し立てできます。こちら側(先生またはプラットフォーム)の問題であれば、クレジットは必ず返却します。詳細は",
              { text: "クレジット購入規約", to: "/terms" },
              "をご覧ください。",
            ],
          },
